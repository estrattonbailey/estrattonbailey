      ...
      body: (
        <div className="p12 f jcb fw">
          <div className='pr10'>
            ...
            <a href='https://github.com/estrattonbailey' target='_blank' className='link db'>GitHub</a>
            <a href='https://twitter.com/estrattonbailey' target='_blank' className='link db'>Twitter</a>

            <h1 className="fs4 mb6 mt10">Projects</h1>

            <a href='https://presta.run' target='_blank' className='link db'>Presta</a>
            <a href='https://github.com/sure-thing' target='_blank' className='link db'>Sure Thing</a>
            <p className='db'>Picostack (soon)</p>
          </div>

          <div className='history mt10 w gray'>
            <h1 className='history__title fs4 mb6'>
              <a className='db' href='https://www.are.na/eric-bailey/every-thing' target='_blank'>History</a>
            </h1>
