(() => {
  ...
  var require_nano_css = __commonJS({
    "node_modules/.pnpm/github.com+estrattonbailey+nano-css@f543daab20a282072b4e1bf90930f701c6228a9d_react-dom@17.0.2+react@17.0.2/node_modules/nano-css/index.js"(exports) {
      "use strict";
      var KEBAB_REGEX = /[A-Z]/g;
      var hash = function(str) {
        var h2 = 5381, i3 = str.length;
        while (i3)
          h2 = h2 * 33 ^ str.charCodeAt(--i3);
  ...
  var require_cache = __commonJS({
    "node_modules/.pnpm/github.com+estrattonbailey+nano-css@f543daab20a282072b4e1bf90930f701c6228a9d_react-dom@17.0.2+react@17.0.2/node_modules/nano-css/addon/cache.js"(exports) {
      "use strict";
  ...
  var require_nesting = __commonJS({
    "node_modules/.pnpm/github.com+estrattonbailey+nano-css@f543daab20a282072b4e1bf90930f701c6228a9d_react-dom@17.0.2+react@17.0.2/node_modules/nano-css/addon/nesting.js"(exports) {
      "use strict";
      exports.addon = function(renderer) {
  ...
  var require_warnOnMissingDependencies = __commonJS({
    "node_modules/.pnpm/github.com+estrattonbailey+nano-css@f543daab20a282072b4e1bf90930f701c6228a9d_react-dom@17.0.2+react@17.0.2/node_modules/nano-css/addon/__dev__/warnOnMissingDependencies.js"(exports, module) {
      "use strict";
      ...
      module.exports = function warnOnMissingDependencies(addon, renderer, deps) {
        ...
        if (missing.length) {
          ...
          for (var j3 = 0; j3 < missing.length; j3++) {
            str += '\n require("' + pkgName + "/addon/" + missing[j3] + '").addon(nano);';
          }
          throw new Error(str);
        }
      };
  ...
  var require_keyframes = __commonJS({
    "node_modules/.pnpm/github.com+estrattonbailey+nano-css@f543daab20a282072b4e1bf90930f701c6228a9d_react-dom@17.0.2+react@17.0.2/node_modules/nano-css/addon/keyframes.js"(exports) {
      "use strict";
  ...
  var require_rule = __commonJS({
    "node_modules/.pnpm/github.com+estrattonbailey+nano-css@f543daab20a282072b4e1bf90930f701c6228a9d_react-dom@17.0.2+react@17.0.2/node_modules/nano-css/addon/rule.js"(exports) {
      "use strict";
      exports.addon = function(renderer) {
        if (true) {
  ...
  var require_global = __commonJS({
    "node_modules/.pnpm/github.com+estrattonbailey+nano-css@f543daab20a282072b4e1bf90930f701c6228a9d_react-dom@17.0.2+react@17.0.2/node_modules/nano-css/addon/global.js"(exports) {
      "use strict";
      exports.addon = function(renderer) {
        if (true) {
  ...
  var require_hydrate = __commonJS({
    "node_modules/.pnpm/github.com+estrattonbailey+nano-css@f543daab20a282072b4e1bf90930f701c6228a9d_react-dom@17.0.2+react@17.0.2/node_modules/nano-css/addon/hydrate.js"(exports) {
      "use strict";
      exports.addon = function(renderer) {
        if (true) {
  ...
  var require_utils = __commonJS({
    "node_modules/.pnpm/hypostyle@3.1.2_react-dom@17.0.2+react@17.0.2/node_modules/hypostyle/utils.js"(exports, module) {
      function px(v3) {
      ...
      function percOrPx(v3) {
        return typeof v3 === "number" ? v3 <= 1 ? v3 * 100 + "%" : v3 + "px" : v3;
      }
      module.exports = {
        px,
        str,
  ...
  var require_properties = __commonJS({
    "node_modules/.pnpm/hypostyle@3.1.2_react-dom@17.0.2+react@17.0.2/node_modules/hypostyle/properties.js"(exports, module) {
  ...
  var require_hypostyle = __commonJS({
    "node_modules/.pnpm/hypostyle@3.1.2_react-dom@17.0.2+react@17.0.2/node_modules/hypostyle/index.js"(exports, module) {
      ...
      function hypostyle2(theme = {}, config = {}) {
        ...
        const addons = [cache, nesting, keyframes, rule, globalAddon, hydrate].concat(config.addons || []);
  ...
  var require_presets = __commonJS({
    "node_modules/.pnpm/hypostyle@3.1.2_react-dom@17.0.2+react@17.0.2/node_modules/hypostyle/presets.js"(exports, module) {
  ...
  function L(l3, u3, i3, t3, o3, r3, f3, c3) {
    ...
    if (d3 === "svg" && (o3 = true), r3 != null) {
      for (; _2 < r3.length; _2++)
        if ((s2 = r3[_2]) && (s2 === l3 || (d3 ? s2.localName == d3 : s2.nodeType == 3))) {
          l3 = s2, r3[_2] = null;
          break;
        }
    }
    ...
    if (d3 === null)
      ...
      if (C(l3, p2, y2, o3, c3), v3)
        ...
        for (_2 = r3.length; _2--; )
          r3[_2] != null && h(r3[_2]);
      c3 || ("value" in p2 && (_2 = p2.value) !== void 0 && (_2 !== l3.value || d3 === "progress" && !_2) && H(l3, "value", _2, y2.value, false), "checked" in p2 && (_2 = p2.checked) !== void 0 && _2 !== l3.checked && H(l3, "checked", _2, y2.checked, false));
    }
    return l3;
  }
  function M(n2, u3, i3) {
  ...
  var initialMatrix = JSON.parse(localStorage.getItem(LS_MATRIX_KEY) || JSON.stringify(defaultMatrix));
  ...
  function Box({ as = "div", cx = {}, children, ...rest }) {
    ...
    return v(as, {
      ...
      ].filter(Boolean).map((s2) => s2.trim()).join(" ")
    }, children);
  }
  function App() {
    ...
    return /* @__PURE__ */ v("div", {
      className: "p12"
    }, /* @__PURE__ */ v("h3", null, "Ascii Art Animation Generator"), /* @__PURE__ */ v("div", {
      className: "f"
    }, /* @__PURE__ */ v("div", {
      className: "matrix f mono fs2"
    }, matrix.map((row, rowIndex) => /* @__PURE__ */ v(Box, {
      key: rowIndex,
      f: true,
      cx: {
    ...
    }, row.map((col, colIndex) => /* @__PURE__ */ v("div", {
      key: colIndex,
      "data-row": rowIndex,
      "data-col": colIndex,
      d: "block",
    ...
    })))))), /* @__PURE__ */ v("button", null, "Capture"), /* @__PURE__ */ v("button", {
      onClick: resetMatrix
    }, "Reset Current Frame"), /* @__PURE__ */ v("button", {
      onClick: resetAll
    }, "Reset All"));
  }
